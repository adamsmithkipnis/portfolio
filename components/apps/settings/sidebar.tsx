...
const connectivityItems = [
  ...
  { id: "wifi", name: "Wi-Fi", icon: <Wifi className="w-5 h-5 text-white" />, iconBg: "bg-blue-500", type: "value" as const, value: "virus.exe" },
...
const appleAccountKeywords = ["adam", "smith-kipnis", "apple", "account", "personal", "information", "name", "birthday"];
